...
window.addEventListener('load', () =>  {
    ...
    audio = document.getElementById("audio"); //- 'music'
    audio.volume = 1; //-no need to change the volume 
    vol = document.getElementById("volumeSlider"); //- 'volumeSlider'
    colorSelect = document.getElementById("colorSelect"); //- no need for select 
...
audioFile.onchange = function () { 
    ...
    //- this all things will go under my 'loadSong'
